...
export default function Settings({ theme, setTheme }) {
    ...
    return (
        <div className="p-4 md:p-6 max-w-4xl mx-auto w-full min-h-[calc(100vh-80px)] flex flex-col pb-24 md:pb-8">
            <header className="mb-8 animate-fade-in">
                <h1 className="text-2xl md:text-3xl font-extrabold text-gray-800 dark:text-white">Settings</h1>
            ...
            <div className="space-y-6 flex-1 animate-slide-up">
                {/* Account Section */}
                <div className="bg-white dark:bg-slate-800 p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 flex items-center justify-between transition-colors">
